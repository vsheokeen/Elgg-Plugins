...
echo elgg_view("output/confirmlink", array(
	'href' => elgg_get_site_url() . "action/elggx_groupuserpoints/reset?user_guid=0",
	'text' => elgg_echo('elggx_groupuserpoints:reset:all'),
	'is_action' => true,
	'is_trusted' => true,
	'confirm' => elgg_echo('elggx_groupuserpoints:reset:all:confirm'),
	'class' => 'elgg-button elgg-button-action'
));
echo "</b><br><br>";

$action = elgg_get_site_url() . 'action/elggx_groupuserpoints/settings';
...
$form .= elgg_echo('elggx_groupuserpoints:settings:transaction_status_info');
$form .= "<br><b>" . elgg_echo('elggx_groupuserpoints:settings:transaction_status') . "</b>";
$form .= elgg_view('input/dropdown', array(
	'name' => 'params[moderate]',
	'options_values' => array('1' => elgg_echo('elggx_groupuserpoints:settings:moderated'), '0' => elgg_echo('elggx_groupuserpoints:settings:approved')),
	'value' => $plugin->moderate
));

$form .= "<br><br><b>" . elgg_echo('elggx_groupuserpoints:settings:profile_display') . "</b>";
$form .= elgg_view('input/dropdown', array(
...
$form .= "<br><br><b>" . elgg_echo('elggx_groupuserpoints:settings:displaymessage') . "</b>";
$form .= elgg_view('input/dropdown', array(
...
$form .= "<br><br><b>" . elgg_echo('elggx_groupuserpoints:settings:subtract') . "</b>";
$form .= elgg_view('input/dropdown', array(
...
$form .= "<br><br><b>" . elgg_echo('elggx_groupuserpoints:settings:delete') . "</b>";
$form .= elgg_view('input/dropdown', array(
	'name' => 'params[delete]',
	'options_values' => array(
		'1' => elgg_echo('elggx_groupuserpoints:settings:yes'),
		'0' => elgg_echo('elggx_groupuserpoints:settings:no')
	),
	'value' => $plugin->delete
));
$form .= "<br>" . elgg_echo('elggx_groupuserpoints:settings:delete:note');

$form .= "<br><br><b>" . elgg_echo('elggx_groupuserpoints:settings:expire_after') . "</b>";
$form .= elgg_view('input/dropdown', array(
...
$form .= "<br>" . elgg_echo('elggx_groupuserpoints:settings:expire_after:help');
