...
$plugin = elgg_get_plugin_from_id('elggx_groupuserpoints');
?>


<div class="elggx_groupuserpoints_actions">
	<form method="POST" action="<?php echo elgg_add_action_tokens_to_url(elgg_get_site_url() . 'action/elggx_groupuserpoints/settings'); ?>">
	...
	<tr><td></td><td>&nbsp;</td></tr>
	<tr><td><h3><?php echo elgg_echo('groupuserpoints_standard:loginsettings'); ?></h3></td><td>&nbsp;</td></tr>
	<tr><td colspan="2"><hr /><br /></td></tr>

	<tr>
		<td><label><?php echo elgg_echo('groupuserpoints_standard:login'); ?></label></td>
	...
	<tr>
		<td><label><?php echo elgg_echo('groupuserpoints_standard:login_threshold'); ?></label></td>
		<td><?php $login_threshold = $plugin->login_threshold; ?>
			<select name="params[login_threshold]">
				<option value="3600" <?php if ($login_threshold == '3600') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:1hour'); ?></option>
				<option value="14400" <?php if ($login_threshold == '14400') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:4hours'); ?></option>
				<option value="28800" <?php if ($login_threshold == '28800') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:8hours'); ?></option>
				<option value="43200" <?php if ($login_threshold == '43200') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:12hours'); ?></option>
				<option value="86400" <?php if ($login_threshold == '86400') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:1day'); ?></option>
				<option value="604800" <?php if ($login_threshold == '604800') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:1week'); ?></option>
				<option value="2592000" <?php if ($login_threshold == '2592000') echo " selected=\"yes\" "; ?>><?php echo elgg_echo('groupuserpoints_standard:1month'); ?></option>
			</select>
		</td>
	</tr>
	...
	<tr>
		<td><label><?php echo elgg_echo('groupuserpoints_standard:login_interval'); ?></label></td>
