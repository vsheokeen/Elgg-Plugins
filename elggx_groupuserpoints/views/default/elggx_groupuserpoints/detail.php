...
$base_url = elgg_get_site_url() . "admin/administer_utilities/elggx_groupuserpoints?tab=detail";
if ($user_guid) {
...
if ($count=='0') {
	$html .= "<br>" . elgg_echo('elggx_groupuserpoints:approved_empty');
} else {
	...
	foreach ($entities as $entity) {
		...
		$info .= "(<a href=\"" . elgg_add_action_tokens_to_url(elgg_get_site_url() . "action/elggx_groupuserpoints/delete?guid={$entity->guid}") . "\">".elgg_echo('elggx_groupuserpoints:delete')."</a>)";
