...
%s",
	...
	'groups:ecml:groupprofile' => 'Group profiles',
	 'grouppoints_balance:menu' => 'Group User Point balance',
    'grouppoints_balance:title' => 'Group User Point balance',

    'grouppoints_balance:overview' => 'On this page you can report how many hours you have worked on revisions. For every hour you will be rewarded with %s group points.',
    'grouppoints_balance:hours_worked' => 'How many hours have you worked on revisions? ',
    'grouppoints_balance:description' => 'Optionally you can describe briefly what you have been working on: ',
    'grouppoints_balance:proceed' => 'Reward me!',

    'grouppoints_balance:no_description' => '%s hasn\'t added an accompanying text.',

    'grouppoints_balance:pointfail' => "An error occured within the userpoints api!",
    'grouppoints_balance:pointsuccess' => "You have been rewarded with %s userpoints for %s hours of revisions."
);
